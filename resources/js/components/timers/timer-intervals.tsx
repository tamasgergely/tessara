...
export default function TimerIntervals({ initalIntervals, onDelete }: { initalIntervals: TimerInterval[], onDelete: (interval: TimerInterval) => void }) {
    ...
    const handleBlur = async (interval: TimerInterval, field: 'start' | 'stop') => {
        ...
        if (newValue === undefined || newValue === formatTime(interval[field])) {
            return;
        }
                        ...
                        <div className="flex items-center gap-2">
                            <div className="relative">
                                <Input
                                    ...
                                    value={editingValues[`${interval.id}-start`] ?? formatTime(interval.start)}
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    value={editingValues[`${interval.id}-stop`] ?? formatTime(interval.stop)}
